...
struct SettingsView: View {
    ...
    private var permissionCard: some View {
        Card(title: "Tunk is not armed",
             caption: "Detection stays off until both are granted, or Tunk could not see "
                    + "your typing and would fire while you type.") {
            VStack(alignment: .leading, spacing: 8) {
                ...
                permissionRow("Accessibility", "posts the hotkey and sees typing",
