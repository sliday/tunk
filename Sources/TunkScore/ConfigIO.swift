...
enum ConfigParam: String, CaseIterable {
    ...
    case onsetCeilingG
    case motionGateG
    case ringCombDelaySamples
    case ringCombCoefficient
    ...
    func set(_ c: inout DetectorConfig, _ v: Double) {
        ...
        case .ringCombDelaySamples: c.ringCombDelaySamples = Int(v.rounded())
        case .ringCombCoefficient: c.ringCombCoefficient = v
        }
    }
    ...
    func get(_ c: DetectorConfig) -> Double? {
        ...
        case .ringCombDelaySamples: return Double(c.ringCombDelaySamples)
        case .ringCombCoefficient: return c.ringCombCoefficient
        }
    }
