...
enum ConfigParam: String, CaseIterable {
    ...
    case onsetCeilingG
    case motionGateG
    case secondTapThresholdFraction
    case secondTapBaselineFraction
    ...
    func set(_ c: inout DetectorConfig, _ v: Double) {
        ...
        case .secondTapThresholdFraction: c.secondTapThresholdFraction = v
        case .secondTapBaselineFraction: c.secondTapBaselineFraction = v
        }
    }
    ...
    func get(_ c: DetectorConfig) -> Double? {
        ...
        case .secondTapThresholdFraction: return c.secondTapThresholdFraction
        case .secondTapBaselineFraction: return c.secondTapBaselineFraction
        }
    }
